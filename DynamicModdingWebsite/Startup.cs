...
namespace DynamicModdingWebsite
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                AuthenticationScheme = "SmithsModding-Hub"
            });
            ...
            {
                AuthenticationScheme = "SmithsModding-Hub",
                DisplayName = "SmithsModding-Hub",
                ClientId = Configuration["hub:clientId"],
                ClientSecret = Configuration["hub:clientSecret"],
                CallbackPath = new PathString("/signin-hub"),
                AuthorizationEndpoint = "https://auth.smithsmodding.com/hub/api/rest/oauth2/auth",
                TokenEndpoint = "https://auth.smithsmodding.com/hub/api/rest/oauth2/token",
                UserInformationEndpoint = "https://auth.smithsmodding.com/hub/api/rest/users/guest",
                Scope = { Configuration["hub:clientId"] },
            ...
            app.Map("/login", builder =>
            {
                builder.Run(async context =>
                {
                    ...
                    await context.Authentication.ChallengeAsync("SmithsModding-Hub", properties: new AuthenticationProperties() { RedirectUri = "/" });
                });
            });
